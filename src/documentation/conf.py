...
project = u"Demand for Security: Another Way to Measure Risk Aversion"
copyright = u"2019-, Yan Luo"
...
latex_documents = [(
    ...
    "Documentation of the Demand for Security: Another Way to Measure Risk Aversion project",
    "Yan Luo",
    "manual"
)]
